...
import CustomSuccessAlert from './Alert';
...
const SignupForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5200/api/users', {
        method: 'POST',
        headers: {
      ...
      // this will redirect the user to login page or clear form
    } catch (error) {
  ...
  return (
    ...
    className="min-h-screen w-full flex items-center justify-center bg-cover bg-center bg-no-repeat" 
      ...
      {showSuccessAlert && <CustomSuccessAlert message="Signup successful! Please log in." />}
